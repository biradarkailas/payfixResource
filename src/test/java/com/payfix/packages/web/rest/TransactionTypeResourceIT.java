...
class TransactionTypeResourceIT {
    ...
    void createTransactionType() throws Exception {
        ...
        restTransactionTypeMockMvc
            .perform(
                post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(transactionTypeDTO))
            )
    ...
    void putWithMissingIdPathParamTransactionType() throws Exception {
        ...
        restTransactionTypeMockMvc
            .perform(
                put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(transactionTypeDTO))
            )
